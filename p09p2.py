...
class Extrapolater:
    ...
    def _interpolate_backward(self):
        # prepend zero to last row
        self._rows[-1].insert(0, 0)
...
def main():
    ...
    for line in input_data:
        ...
        for r in e._rows:
            print(r)
        print('-----------------')
        sum_of_prev_history_values += e.get_val_in_sequence()

    print(sum_of_prev_history_values)
